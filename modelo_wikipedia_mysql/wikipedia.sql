...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2017 a las 20:28:33
...
CREATE TABLE `tbl_archivos` (
  ...
  `TAMAÑO_ARCHIVO` double DEFAULT NULL COMMENT 'SE REFIERE AL PESO DEL ARCHIVO',
...
CREATE TABLE `tbl_comentarios` (
  ...
  `CODIGO_ARTICULO` int(11) NOT NULL COMMENT ' \n',
  `COMENTARIO` varchar(2000) DEFAULT NULL COMMENT ' \n'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_generos` (
  ...
  `NOMBRE_GENERO` varchar(200) DEFAULT NULL,
...
INSERT INTO `tbl_historial_articulo` (`CODIGO_CUENTA`, `CODIGO_SECCION`, `FECHA_EDICION`, `CONTENIDO`) VALUES
(1, 3, '2016-10-10 00:00:00', 'Como busco informacion relacionada'),
(2, 1, '2016-10-10 00:00:00', 'buen articulo leere otro');
...
CREATE TABLE `tbl_husos_horarios` (
  ...
  `NOMBRE_HUSO_HORARIO` varchar(200) DEFAULT NULL,
...
CREATE TABLE `tbl_idiomas` (
  ...
  `CODIGO_ARTICULO` int(11) NOT NULL,
  `NOMBRE_IDIOMA` varchar(200) DEFAULT NULL,
  `NUMERO_ARTICULOS` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_portales` (
  ...
  `NOMBRE_PORTAL` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_reporte_errores` (
  ...
  `CODIGO_ARTICULO` int(11) NOT NULL,
  `NOMBRE_ERROR` varchar(200) DEFAULT NULL,
...
CREATE TABLE `tbl_tipos_notificaciones` (
  `CODIGO_TIPO_NOTIFICACION` int(11) NOT NULL,
  `NOMBRE_TIPO_NOTIFICACION` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_tipo_de_articulos` (
  `CODIGO_TIPO_ARTICULO` int(11) NOT NULL,
  `NOMBRE_TIPO_ARTICULO` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_tipo_lugar` (
  `CODIGO_TIPO_LUGAR` int(11) NOT NULL,
  `NOMBRE_TIPO_LUGAR` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tbl_usuarios` (
  ...
  `CONTRASEÑA` varchar(50) DEFAULT NULL COMMENT 'CLAVE PARA ENTRAR A CUENTA',
  `FECHA_NACIMIENTO` datetime DEFAULT NULL,
  `DIRECCION_IP` varchar(50) DEFAULT NULL COMMENT 'SE UITLIZA PARA IDENTIFICAR A LOS USUARIOS NO REGISTRADOS.',
...
INSERT INTO `tbl_usuarios` (`CODIGO_USUARIO`, `CODIGO_GENERO`, `CODIGO_LUGAR_RESIDENCIA`, `CODIGO_LUGAR_NACIMIENTO`, `CODIGO_TIPO_USUARIO`, `CODIGO_ARTICULO_USUARIO`, `CODIGO_HUSO_HORARIO`, `USERNAME`, `NOMBRE`, `APELLIDO`, `CORREO_ELECTRONICO`, `CONTRASEÑA`, `FECHA_NACIMIENTO`, `DIRECCION_IP`, `NUMERO_FALTAS`) VALUES
(1, 2, 2, 2, 2, 2, 2, 'Batman', 'Burno', 'Diaz', 'yosoybatman@gmail.com', 'asd.123', '1990-10-10 00:00:00', '192.168.1.2', 0),
(2, 2, 3, 3, 2, 1, 2, 'Joker', 'Mariano', 'Gonzales', 'Joker@yahoo.com', 'asd.456', '1991-10-10 00:00:00', '192.168.12.4', 5),
(3, 1, 4, 3, 1, 3, 2, 'markk333', 'mark', 'Zuckember', 'mark@htmail.com', 'asd.456', '1990-10-10 00:00:00', '192.168.10.25', 0),
(4, 1, 3, 3, 1, 2, 3, 'carlosrrg', 'Carlos', 'Ramos', 'carlos@gmail.com', 'asd.456', '1994-10-10 00:00:00', '192.168.1.23', 0),
(5, 1, 3, 2, 2, 2, 2, 'ikser789', 'ikser', 'martinez', 'ikser@gmail.com', 'asd.456', '1990-10-10 00:00:00', '192.168.1.26', 3);
...
CREATE TABLE `tipo_proteccion` (
  `CODIGO_TIPO_PROTECCION` int(11) NOT NULL,
  `NOMBRE_TIPO_PROTECCION` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `tbl_historial_articulo`
  ADD PRIMARY KEY (`CODIGO_CUENTA`,`CODIGO_SECCION`),
  ADD KEY `ARTI_X_USU_SECCIONES_FK` (`CODIGO_SECCION`),
  ADD KEY `SECCI_X_USUAR_CUENTAS_FK` (`CODIGO_CUENTA`);
...
--
-- AUTO_INCREMENT de la tabla `tbl_estados_prefrencias`
--
ALTER TABLE `tbl_estados_prefrencias`
  MODIFY `CODIGO_ESTADO_PREFERENCIA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `tbl_estado_notificaciones`
--
ALTER TABLE `tbl_estado_notificaciones`
...
--
-- AUTO_INCREMENT de la tabla `tbl_husos_horarios`
--
ALTER TABLE `tbl_husos_horarios`
  MODIFY `CODIGO_HUSO_HORARIO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `tbl_reporte_errores`
--
ALTER TABLE `tbl_reporte_errores`
  MODIFY `CODIGO_REPORTE_ERROR` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `tbl_sanciones`
--
ALTER TABLE `tbl_sanciones`
  MODIFY `CODIGO_SANCION` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `tbl_tipos_notificaciones`
--
ALTER TABLE `tbl_tipos_notificaciones`
  MODIFY `CODIGO_TIPO_NOTIFICACION` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `tbl_tipos_preferencias`
--
ALTER TABLE `tbl_tipos_preferencias`
  MODIFY `CODIGO_TIPO_PREFRENCIA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
ALTER TABLE `tbl_historial_articulo`
  ...
  ADD CONSTRAINT `SECCI_X_USUAR_CUENTAS_FK` FOREIGN KEY (`CODIGO_CUENTA`) REFERENCES `tbl_cuentas` (`CODIGO_CUENTA`);
