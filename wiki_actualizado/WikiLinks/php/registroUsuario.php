							...
							<h1>Crea Tu Cuenta!</h1>
						        <form id="registroUser" action="">
					           		<table class="table table-hover">
									   	<tr>
									    	<td>Usuario:</td>
									        <td><input id="txt-nombre" name="txt-nombre" placeholder="Ingresa un nombre de usuario" type="text" class="form-control"></td>
									    </tr>
									    <tr>
									    	<td>Contrasena:</td>
									        <td><input id="txt-contrasena" name="txt-contrasena" placeholder="Escribe una contrasena" type="password" class="form-control"></td>
									    </tr>
									    <tr>
									    	<td>Repite Contrasena</td>
									        <td><input id="txt-confirmar-contrasena" name="txt-confirmar-contrasena" placeholder="Repite la contrasena" type="password" class="form-control"></td>
									    </tr>
									    <tr>
									    	<td>Direccion de correo</td>
									        <td><input id="txt-correo" name="txt-correo" placeholder="Ingresa un correo(opcional)" type="email" class="form-control"></td>
									    </tr>
									    <tr>
									        <td colspan="2">
									            <center>
									            <button type="button" class="btn btn-primary" id="btn-registrar"   name="btn-registrar" style="background-color: #447FF5;" data-loading-text="Guardando..." >Registrarme</button>
						      	...
						      	<div id="resultado" name="resultado">hola</div>  
						    </div>
							


							<div class="col-md-6 portfolio-item"> 
								<center><h2>Personas como vos son las que construyen Wikilinks!</h2>
				  				<h3>987,5464,8466</h3>
