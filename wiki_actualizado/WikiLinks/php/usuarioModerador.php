				...
				<div   class=" col-xs-12 col-sm-12 col-md-10 col-lg-10 ">
					<div class="row">
						...
						<div class="col-xs-12 col-lg-12">
							...
							<center><h1>Bienvenido, Revisa articulos antes de subirlos </h1></center>
						        ...
						        <form id="ver-articulos" action="">
					           		...
					           		<table class="table table-hover">
									    ...
									    <tr>
									        <td colspan="2">
									            <center>
										            <input name="ingresar" type="submit" value="Ir" class="btn btn-default">
										            <input name="ingresar" type="submit" value="Reportes" class="btn btn-default">
										            <input name="ingresar" type="submit" value="Articulos" class="btn btn-default">
									            </center>
									        </td>
									    </tr>
						      		</table>
						    ...
						    <div class="col-md-6 portfolio-item" > 
							    <center><h2>Articulos por revisar admin: <a href="">@admin</a></h2></center>
									<form id="val-admin" action="">
										...
										<tr>
										    ...
										    <td><a href="">Nombre Usuario o E-mail</a></td>
										</tr>
							      	...
							      	<center><h2>Reportes de articulos enviados admin: <a href="">@admin</a></h2></center>
									<form id="ver-articulos" action="">
						           		<table class="table table-hover">
										  <tr>
										    <th scope="col">Nombre del Articulo</th>
