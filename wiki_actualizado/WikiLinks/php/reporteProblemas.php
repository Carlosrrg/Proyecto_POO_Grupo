				...
				<div   class=" col-xs-12 col-sm-12 col-md-10 col-lg-10 ">
					<div class="row">
						...
						<div class="col-xs-12 col-lg-12">
							...
							<h1>Reporta un Problema!</h1>
						        <form id="registroUser" action="">
				           			<table class="table table-hover" style="margin: 0 auto; text-align: left; width: 500px">
								   	<tr>
								    	<td>Nombre:</td>
								        <td><input id="nombre" name="nombre" placeholder="Ingresa un nombre" type="text" class="form-control"></td>
								    </tr>
								    <tr>
								    	<td>Correo:</td>
								        <td><input id="correo" name="correo" placeholder="Escribe una correo" type="email" class="form-control"></td>
								    </tr>
								    <tr>
								    	<td>Asunto</td>
								        <td><input id="asunto" name="asunto" placeholder="Asunto" type="input" class="form-control"></td>
								    </tr>
								    <tr>
								    	<td>Descripcion</td>
								        <td><textarea class="form-control" rows="5" id="descripcion"></textarea></td>
								    </tr>
								    <tr>
								        <td colspan="2">
