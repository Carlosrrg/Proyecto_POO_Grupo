				...
				<div   class=" col-xs-12 col-sm-12 col-md-10 col-lg-10 ">
					<div class="row">
						...
						<div class="col-xs-12 col-lg-12"><br>
							...
							<iframe id="ifr" frameborder="0" name="ifr" scrolling="no" height="100%" width="100%" frameborder="0" scrolling="no" src="../Articulos/Unah.html" name="iframe_a"></iframe>
							

							<center>
								<input name="aprobar-articulo" type="submit" value="Aprobar" class="btn btn-primary">
								<input name="denegar-articulo" type="submit" value="Denegar" class="btn btn-danger">
							</center>
						</div>
