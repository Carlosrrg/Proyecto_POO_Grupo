							...
							<h1>Reporta un Articulo :/</h1>
						        <form id="registroUser" action="">
					           		<table class="table table-hover" style="margin: 0 auto; text-align: left; width: 500px">
									   	<tr>
									    	<td>Correo:</td>
									        <td><input id="correo" name="correo" placeholder="Ingresa tu correo electronico" type="email" class="form-control"></td>
									    </tr>
									    <tr>
									    	<td>Motivo</td>
									        <td><textarea placeholder="Explicanos el motivo de tu reporte"class="form-control" rows="5" id="motivo"></textarea></td>
									    </tr>
									    <tr>
									        <td colspan="2">
									            <center><input name="enviar-reporte" type="submit" value="Enviar Reporte" class="btn btn-default"  ></center>
									        </td>
									    </tr>
						      		</table>
						      	</form>   
